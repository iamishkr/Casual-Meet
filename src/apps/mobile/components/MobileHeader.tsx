...
export default function MobileHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-14 w-full items-center justify-between border-b border-line-soft bg-night-900/90 px-4 backdrop-blur-lg">
      {/* Brand */}
      ...
      <div className="flex items-center gap-2">
        ...
        {/* Switch to Web App View (for desktop browsers) */}
        <Link
          to="/app"
          className="flex h-8 w-8 items-center justify-center rounded-lg border border-line bg-night-850 text-mute hover:text-amber transition-colors"
          title="Switch to Desktop Web Experience"
        >
          <Laptop size={15} />
        </Link>
